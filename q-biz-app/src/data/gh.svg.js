...
const simplemaps_countrymap_mapinfo = {
  ...
  default_labels: {},
  proj_coordinates: [
    { x: 50.9, y: 1381, lat: 5.06, lng: -3.039 },
    { x: 549.9, y: 802.5, lat: 7.631, lng: -0.808 },
    { x: 949.1, y: 74.2, lat: 10.845, lng: 0.977 },
  ],
  initial_view: { x: -155, y: 1, x2: 1165, y2: 1468 },
};
