  ...
  <main>
    <section>
      <div class="row bg-brand text-white q-pa-sm">
        <div class="col-6">Region: {{ Ashanti.region }}</div>
        <div class="col-6">Capital: {{ Ashanti.capital }}</div>
      </div>
    </section>
    ...
    <section class="row q-col-gutter-sm q-pa-sm constituencies">
      <div v-for="(constituency, index) in constituencies()" :key="constituency.code" class="col-6 constituency"
        ...
        <router-link :to="`/constituencies/ashanti/${constituency.constituency
          .toLowerCase()
          .replaceAll(' ', '-')}`">
            ...
            <q-card-section class="row">
              ...
              <div class="col-12">
                ...
                <div>
                  ...
                  <div>
                    <div>
                      <q-badge class="bg-brand q-pa-sm text-white" v-if="PresParlWinners[index].prezParty.id !=
...
import { Ashanti } from "../../../data/constituency results/ashanti";
import {
  format,
  constituency,
} from "../../../data/constituency results/__functions";
const _all = Ashanti.results;
...
const candidates = Ashanti.results.map((item) => {
...
const _constituencies = Ashanti.results.map((i) => i.constituency);
