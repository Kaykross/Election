...
const condition = Ashanti.results
...
const ConstituencyName = condition.length ? ref(c_name) : ref("new edubiase");

const ConstituencyData = constituency(Ashanti, ConstituencyName.value);
