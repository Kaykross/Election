  ...
  <main>
    <section>
      <div class="row bg-brand text-white q-pa-sm">
        <div class="col-6">Region: {{ BonoEast.region }}</div>
        <div class="col-6">Capital: {{ BonoEast.capital }}</div>
      </div>
    </section>
    <section>
      <div>
...
import { BonoEast } from "../../../data/constituency results/bonoEast";
import {
  format,
  constituency,
...
const condition = BonoEast.results
...
// console.log(BonoEast);

const ConstituencyData = constituency(BonoEast, ConstituencyName.value);
